...
public class Adapter_OrdersNew extends RecyclerView.Adapter<Adapter_OrdersNew.MyViewHolder> {
    ...
    public Adapter_OrdersNew(List<Order> list, Fragment_Rider_New rContext, Context context) {
   ...
   public Adapter_OrdersNew(Context context, OnItemClickListener listener){
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView merchant_name, order_id, merchant_add, buyer_add, outcoming;
        Button btn_accept;
        ...
        public MyViewHolder(View itemView){
            ...
            outcoming = itemView.findViewById(R.id.outcoming);
