...
public class Activity_Rider_Main extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        context = Activity_Rider_Main.this;
...
//        }
    ...
    private void loadBottomNavigationBar() {
        ...
        replaceFragment(new Fragment_Rider_New());
            ...
            public void onTabSelected(int position) {//未选中 -> 选中
                switch (position) {
                    ...
                    case 2:
                        ...
                        replaceFragment(new Fragment_Rider_Sta());
                        break;
                    case 3:
                        toolbarText.setText("我的");
                        replaceFragment(new Fragment_Rider_My());
                        break;
                    default:
                        break;
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
         ...
         */
        if(requestCode==3111 && resultCode == 3222){
            toolbarText.setText("处理中");
            replaceFragment(new Fragment_Rider_Underway());
            // 在这设置选中你要显示的fragment
        }
